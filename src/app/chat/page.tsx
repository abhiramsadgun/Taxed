...
import { Send, Bot, User as UserIcon, Loader2, Sparkles, ArrowLeft } from "lucide-react";
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "msg_1",
      role: "assistant",
      content: `Hello ${user?.name.split(' ')[0] || 'Guest'}! I am your GSTShield AI Assistant. I can help you with GST compliance, law explanations, or analyzing your current tax data. How can I help you today?`
    }
  ]);
